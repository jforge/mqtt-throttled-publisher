...
class MQTTDataPublisher:
    ...
    def generate_sensor_data(self, sensor_id: int) -> Dict[str, Any]:
        ...
        base_data.update({
            ...
            "last_maintenance": (datetime.utcnow().timestamp() - random.randint(86400, 2592000)) * 1000,
            # Last 1-30 days
            "next_maintenance": (datetime.utcnow().timestamp() + random.randint(86400, 7776000)) * 1000
            # Next 1-90 days
        })
    ...
    def publish_all_endpoints(self) -> Dict[str, Any]:
        """
        Publish data to all configured endpoints in batches.
    ...
    def run_publisher(self):
        """
        Main publisher loop that runs until shutdown is requested.
        """
        logger.info("Starting MQTT Data Publisher")
        ...
        try:
            ...
            while not self.shutdown_event.is_set():
                ...
                # Wait for the next iteration or shutdown
